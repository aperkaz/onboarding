	  ...
	  html: `<!DOCTYPE html>
				<html>
					...
					<body style="border: 1px solid #ddd; font-family: avenir;">
						<a target="_blank" href="${URL}/public/landingpage/${recipient.campaignId}/${recipient.id}?transition=loaded">
