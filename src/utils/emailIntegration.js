        ...
        html: `<!DOCTYPE html>
            <html>
              ...
              <body style="border: 1px solid #ddd; font-family: avenir;">
                <a target="_blank" href="${URL}/public/landingpage/c_${campaignContact.Campaign.customerId}/${campaignContact.Campaign.campaignId}/${campaignContact.id}?transition=loaded">
                  <img src="${BLOB_URL}/public/api/c_${campaignContact.Campaign.customerId}/files/public/onboarding/eInvoiceSupplierOnboarding/emailTemplates/generic/header.png" alt="header image" width="100%">
                </a>
                <a target="_blank" href="${URL}/public/landingpage/c_${campaignContact.Campaign.customerId}/${campaignContact.Campaign.campaignId}/${campaignContact.id}?transition=loaded">
                  <img src="${BLOB_URL}/public/api/c_${campaignContact.Campaign.customerId}/files/public/onboarding/eInvoiceSupplierOnboarding/emailTemplates/generic/logo.png" alt="image with logo" width="200px" style="margin: 15px">
                </a>
                <section class="container-fluid">
                  <article style="background: #f9f9f9; padding: 15px; margin:15px;">
                    <h2>Dear ${campaignContact.contactFirstName} ${campaignContact.contactLastName} at ${campaignContact.companyName}</h2>
