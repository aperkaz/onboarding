export default {
    ...
    'Campaign.Step0.button.back' : 'List campaigns',
    'Campaign.Step0.button.next' : 'Save & Continue',
    'Campaign.Step1.button.back' : 'Back',
    'Campaign.Step1.button.next' : 'Save & Continue',
    'Campaign.Step2.button.back' : 'Back',
    'Campaign.Step2.button.next' : 'Save & Continue',
    'Campaign.Step2.button.createTemplate' : 'Create new template',
    'Campaign.Step3.button.back' : 'Back',
    'Campaign.Step3.button.next' : 'Save & Continue',
    'Campaign.Step3.button.createTemplate' : 'Create new template',
    'Campaign.Step4.button.back' : 'Back',
    'Campaign.Step4.button.next' : 'Launch campaign',

    'Campaign.Step0.notification.success' : 'The campaign has been saved successfully.',
    'Campaign.Step0.notification.failure' : 'The campaign could not be saved. {error}',
    ...
    'CampaignTemplateSelection.validation.template.required' : 'Please select a template in order to proceed.',

    'CampaignOverview.title.email' : 'Email template',
    'CampaignOverview.title.landingpage' : 'Landing page template',
    'CampaignOverview.title.emailCount' : 'Emails to be sent',
    'CampaignOverview.modal.launchCampaign.title' : 'Launch campaign',
