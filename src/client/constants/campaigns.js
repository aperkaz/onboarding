...
export const CAMPAIGN_DELETE_START = 'CAMPAIGN_CREATE_START';
export const CAMPAIGN_DELETE_SUCCESS = 'CAMPAIGN_CREATE_SUCCESS';
export const CAMPAIGN_DELETE_ERROR = 'CAMPAIGN_CREATE_ERROR';
